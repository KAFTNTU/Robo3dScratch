...
speedWrap.appendChild(speedLabel);
      ...
      // (removed) obstacle editing hint — obstacles are managed from the 3D context menu
...
toggleRunStop(){
    ...
    async runCustomPreview(){
      ...
      if (!code){
        alert('Нема preview JS для міні-блоку (відкрий CustomBlock і натисни Зберегти)');
        return;
      }
